...
import { Play, Eye, ThumbsUp, Star, Clock, MessageSquare, CheckCircle2, FileText } from 'lucide-react';
import {
  discoveryCategories,
    ...
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0">
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <p className="text-blue-100 text-lg">探索工业视觉领域的精彩内容，点赞过的视频会自动同步到个人中心。</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between gap-4 mb-5 text-sm text-gray-500">
          <span>共 {displayVideos.length} 条内容，当前展示 {visibleVideos.length} 条</span>
          <span>切换分类或排序后会自动刷新列表</span>
        </div>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between text-xs text-gray-400 pt-2 border-t border-gray-100">
                    ...
                    {isArticle ? (
                      <span>{video.readTime || '深度阅读'}</span>
                    ) : (
                      isLiked && <span>已同步到个人中心</span>
                    )}
                  </div>
                </div>
              </div>
        ...
        <div className="mt-12 text-center">
          {hasMoreVideos ? (
            <button
              ...
              className="px-8 py-3 bg-white text-gray-700 rounded-lg border border-gray-300 hover:border-blue-600 hover:text-blue-600 transition-all font-medium"
            >
              加载更多内容
            </button>
          ) : (
