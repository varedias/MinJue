...
const Home = () => {
  ...
  const heroBackgroundImage = '/Picture/background.png';
    ...
    <div className="pb-20 md:pb-0 bg-gray-50 min-h-screen">
      ...
      <div className="bg-transparent">
        <div className="max-w-7xl mx-auto px-4 pt-6">
          <div className="relative min-h-[420px] overflow-hidden rounded-[2rem] border border-white/40 shadow-[0_24px_80px_rgba(15,23,42,0.10)] sm:min-h-[520px] lg:min-h-[620px]">
            <div className="absolute inset-0">
              ...
              />
              <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(7,16,34,0.10)_0%,rgba(7,16,34,0.08)_25%,rgba(255,255,255,0.00)_55%,rgba(255,255,255,0.00)_100%)]" />
            </div>

            <div className="relative z-10 flex min-h-[420px] items-end justify-start px-6 py-10 sm:min-h-[520px] lg:min-h-[620px] lg:px-12 lg:pb-12">
                ...
                <form onSubmit={handleSearch} className="flex flex-col gap-3 sm:flex-row">
                    <div className="relative flex-grow">
                      ...
                      <input
                        ...
                        className="w-full rounded-full border border-white/35 bg-white/90 py-4 pl-12 pr-4 text-gray-900 shadow-sm backdrop-blur-sm focus:border-sky-300 focus:outline-none focus:ring-2 focus:ring-sky-300/30"
                      />
                    </div>
                    <button
                      type="submit"
                      className="rounded-full bg-gradient-to-r from-sky-500 to-cyan-500 px-10 py-4 font-medium text-white shadow-lg transition-all hover:from-sky-600 hover:to-cyan-600"
                    >
                      搜索
                    </button>
                </form>
